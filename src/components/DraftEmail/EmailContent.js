    ...
    <div className="font-custom flex flex-col ">
      <div className="flex justify-between items-center mb-2">
        ...
        <div className="rounded-[4px] bg-[#C496FF] py-[3px] px-2 flex justify-center items-center">
          <Image src={Redrafts} className="w-[14px] h-[14px] mr-1" />
      ...
      <div className="flex flex-col gap-y-4">
        <div className="  rounded-[4px] border-[1px] border-[#D1D1D1] max-h-[250px] w-full py-[10px] px-4">
          <div className="flex flex-col items-start gap-y-[7px]">
            ...
            <div className="text-xs  leading-5">
              <spna className="block mb-3">Hello Diane,</spna> I would love to
              meet to discuss the litigation matter from last Friday. Can we
              meet this coming Friday to discuss?
              <span className="block mb-3">I’m available at 5167324900.</span>{" "}
              Thanks
              <br /> Oliver
            </div>
          </div>
        ...
        <hr />
        <div className="flex  justify-end  gap-x-2 font-custom text-[13px] font-normal leading-5  ">
          <div className=" ">
            <Link href="">
              <button
