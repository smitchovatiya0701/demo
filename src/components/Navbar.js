      ...
      <div className="pt-[10px] px-5 gap-x-2">
        <div className="flex flex-row items-center justify-between py-5 ">
          <div className="flex flex-row items-center gap-x-2">
            ...
            <h2 className="font-custom text-xl font-bold leading-7">
              RivetingAI
            </h2>
          </div>
          <div className="flex flex-row gap-x-1">
            ...
            {showButtonInNavbar && (
              <button className="text-[11.639px] text-[#FFFFFF] font-normal leading-[17.732px] py-[4px] pl-[2px] pr-[6px] rounded-[1.913px] bg-[#00B7C3]">
