    ...
    <>
      <div className="flex flex-col w-full h-full mt-3 gap-2">
        <div className="flex justify-between items-center w-full">
          <div
            className="text-[#242424] text-xs font-bold uppercase"
            onClick={() => {
        ...
        <div className="flex justify-between items-center shadow-replybox w-full rounded-[3px] p-2">
          {isToggleChecked ? (
            ...
            <div className="flex flex-col items-start justify-start">
              <div className="text-[#242424] text-xs leading-[18px] font-bold">
                No time entry
              </div>
              <div className="text-[#616161] text-[10px] leading-[14px] font-normal">
                *switch toggle below to log entry
              </div>
            </div>
          )}
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="rounded-[4px] bg-[#C496FF] py-[3px] px-2 flex justify-center items-center gap-1">
            <Image src={Redrafts} width={14} height={14} alt="not found" />
            <div className="text-white text-xs leading-[18px]">Redraft</div>
          </div>
        </div>
        <div className="rounded-[4px] border-[1px] border-[#D1D1D1] max-h-[250px] w-full py-[10px] px-4">
      ...
      <ChangeMatter
        isShowChangeMatter={isShowChangeMatter}
